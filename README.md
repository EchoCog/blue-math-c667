...
```
npm create cloudflare@latest -- --template=cloudflare/templates/blue-math-c667
```

A live public deployment of this template is available at [https://blue-math-c667.templates.workers.dev](https://blue-math-c667.templates.workers.dev)
